...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"messageList.js":[function(require,module,exports) {
"use strict";
...
var MessageList = /*#__PURE__*/function () {
  ...
  _createClass(MessageList, [{
    key: "messagesHandler",
    value: function messagesHandler(islogged) {
      var url = "https://sheltered-spire-00755.herokuapp.com/adminLogin";

      _axios.default.get(url).then(function (response) {
        // handle success
        if (islogged) {
          var listsection = document.getElementById("Messageslist");
          ...
          for (var i = 0; i < response.data.length; i++) {
            ...
            listItem.setAttribute("class", "card text-center w-100 mt-4 shadow p-4");
            var emailAdress = document.createElement("p");
            var adresatName = document.createElement("p");
            ...
            listItem.append(message); // console.log(listItem);
...
},{"axios":"node_modules/axios/index.js"}],"validate.js":[function(require,module,exports) {
"use strict";
...
var Validate = /*#__PURE__*/function () {
  ...
  _createClass(Validate, [{
    key: "validateFields",
    value: function validateFields(str, inputField) {
      var _this = this;
      ...
      if (str.length < 6) {
        ...
        setTimeout(function () {
          _this.header.removeChild(document.getElementById("alertMessage"));
        }, 1000);
        return false;
      } else {
        return true;
    ...
    key: "uncorrectCredentialsHandler",
    value: function uncorrectCredentialsHandler(flag) {
      var _this2 = this;
      ...
      if (!flag) {
        ...
        this.header.append(alertMessage);
        setTimeout(function () {
          _this2.header.removeChild(document.getElementById("alertMessage"));
        }, 1000);
        return false;
      }
...
var Login = /*#__PURE__*/function () {
  ...
  _createClass(Login, [{
    ...
    value: function loginHandler() {
      ...
      var validate = new _validate.Validate();
      var url = "https://sheltered-spire-00755.herokuapp.com/adminLogin"; //VALIDATE INPUTS

      if (validate.validateFields(credentials.adminName, "Name") && validate.validateFields(credentials.adminPassword, "Password")) {
        //VALIDATE CREDENTIALS ON SERVER
        _axios.default.post(url, credentials).then(function (response) {
          if (response.data) {
            _this2.isAuthorized = true;
            _this2.isAuthorized && new _messageList.MessageList(_this2.isAuthorized);

            _this2.toggleBtnText();
          } else {
            validate.uncorrectCredentialsHandler(_this2.isAuthorized);
...
new Login();
},{"./messageList":"messageList.js","./validate":"validate.js","axios":"node_modules/axios/index.js"}],"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/Portfolio-Admin-Site.e31bb0bc.js.map